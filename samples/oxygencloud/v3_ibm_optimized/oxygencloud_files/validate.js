...
(function(window, document, undefined) {    
    ...
    var defaults = {
        messages: {
            ...
            alpha: '%s field must only contain alphabetical characters',
            ...
            valid_oxygen_password: '%s must contain one number & one letter'
        },
    ...
    var ruleRegex = /^(.+)\[(.+)\]$/,
        ...
        oxygenPasswordRegex = /^[\-w]*(?=[\w-]*\d)(?=[\w-]*[a-zA-Z])[\w-]*$/;
    ...
    var FormValidator = function(callback) {
    ...
    FormValidator.prototype._hooks = {
        ...
        */
        ...
        valid_oxygen_password: function(field) {
            return (oxygenPasswordRegex.test(field.value));
        }
    };
